...
class BARTHubInterface(nn.Module):
    ...
    def generate(
        ...
        **kwargs
        ...
        # print("sample is",prefix_sample)
        # print("TEST",prefix_sample['net_input']['src_tokens'].new_zeros((len(prefix), 1)).fill_(self.task.source_dictionary.bos()))
        ...
        #     [self.model],
        #     sample,
        #     sample['net_input']['src_tokens'].new_zeros((len(tokens), 1)).fill_(self.task.source_dictionary.bos()),
        # )
