...
if __name__ == "__main__":
    ...
    while True:
        ...
        while input_e2 is None or input_e2.lower() == "help":
            input_e2 = input(
                "Give an output entity for this input entity and relation (e.g., sleep in tent -- works best if words are lemmatized): "
            )
        ...
        for key, value in outputs.items():
            print(
                "{} \t {} {} {} \t\t norm: {:.4f} \t tot: {:.4f} \t max: {:.4f} \t step: {}".format(
                    input_e1,
                    key,
                    rel_formatting[key],
                    input_e2,
